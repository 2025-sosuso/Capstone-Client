        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[80vh] gap-6 px-4">
                ...
                <div className="text-center space-y-3">
                    <h2 className="text-2xl font-bold text-gray-800">영상을 분석하고 있습니다</h2>
                    <p className="text-gray-600">YouTube에서 데이터를 수집하고 AI 분석을 진행 중입니다.</p>
                ...
                <div className="mt-4 p-4 bg-blue-50 rounded-lg max-w-md">
                    <p className="text-sm text-blue-800">
                        💡 <strong>팁:</strong> 이 페이지를 닫지 마세요. 분석이 완료되면 자동으로 표시됩니다.
                    </p>
                </div>
            </div>
        );
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 px-4">
                ...
                <p className="text-gray-600 text-center">
                    영상 처리 중 문제가 발생했습니다.<br/>잠시 후 다시 시도해주세요.
                </p>
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-5 md:gap-10">
                <div className="flex flex-col gap-5 md:gap-10">
                    <SectionLayout header="AI 전체 요약">
                        <AISummary
                            summary={data.aiAnalysis?.summary ?? null}
                            isLoading={state.isLoading.ai}
                        />
                    </SectionLayout>
